...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 29 18:01:01 2023
...
def program_guidelines():
    """
    Print the program guidelines and instructions.
    """
    print(" ")
    ...
    print("— work through the 'Twitter IO Analysis' folder and establish social nodes between active accounts linked to your queried hashtags. If prompted further, will graphically visualize a social network for you.")
    print(" ")
...
def get_choice():
    while True:
        choice = input("Enter 1, 2, 3, 4, or 5 to run different parts of the program, or x to quit: ")
        if choice in ['1', '2', '3', '4', '5', 'x']:
            return choice
        else:
            print("Invalid input. Please enter 1, 2, 3, 4, 5, or x.")
...
def prompt_user_hashtag_research(account_usernames, username, top_hashtag):
    ...
    if response.lower() != 'y':
        ...
        print(f"Hint: (☞ﾟ∀ﾟ)☞ try analyzing an account in the list of recent unique accounts associated with the inputted user's top hashtag.")
        print("- " * 50)
        return True
...
while True:
    ...
    if choice == "1":
        ...
        print("Invalid input. Please enter 1, 2, or 3 (or 'x' to quit).")